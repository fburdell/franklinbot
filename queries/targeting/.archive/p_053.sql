delete from demspahdcc.commons.hdcc_persuasion_unsurpressed_target where dist_sth = '053';
...
where sc.civis_2020_partisanship > .1 and vf.clarity_turnout_score > .4
and vf.party <> 'D'
) seg_e --civis add
...
where 
  safe_cast(vf.dist_sth as int64) in (53) --check if hd in tiered hd

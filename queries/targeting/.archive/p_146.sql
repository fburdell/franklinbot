delete from demspahdcc.commons.hdcc_persuasion_unsurpressed_target where dist_sth = '146'; 
...
where sc.civis_2020_partisanship > .125 and vf.clarity_turnout_score > .5
and vf.party <> 'D'
) seg_e --civis add
...
where 
  vf.dist_sth in ('146') --check if hd in tiered hd

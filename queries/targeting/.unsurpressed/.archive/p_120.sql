delete from demspahdcc.commons.hdcc_persuasion_unsurpressed_target where dist_sth = '120';
...
) seg_d --unscored non white non dem, STD END
...
where 
  safe_cast(vf.dist_sth as int64) in (120) --check if hd in tiered hd

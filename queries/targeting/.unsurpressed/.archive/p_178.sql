delete from demspahdcc.commons.hdcc_persuasion_unsurpressed_target where dist_sth = '178'; --drops yesterdays target from table
...
where --suppressions and localization
  safe_cast(vf.dist_sth as int64) in (178) --check if hd in tiered hd
